...
{"supercategory": "Tree",       "color": [118,255,99],  "isthing": 1, "id": 12,  "name": "Tree"},
{"supercategory": "Building",   "color": [255,20,20],   "isthing": 1, "id": 13,  "name": "Building"}
]
'''
...
if __name__ == "__main__":
    ...
    for s in ["train"]:
        separate_coco_semantic_from_panoptic(
            os.path.join("annotations/panoptic_train2017.json"),
            os.path.join("panoptic_train2017"),
            os.path.join("panoptic_stuff_train"),
            COCO_CATEGORIES,
        )
        #separate_coco_semantic_from_panoptic(
