...
cfg.DATASETS.TRAIN = ("mitt_dataset_separated")
cfg.DATASETS.TEST = ()
cfg.DATALOADER.NUM_WORKERS = 8
#cfg.SOLVER.IMS_PER_BATCH = 2
cfg.SOLVER.BASE_LR = 0.025
cfg.SOLVER.MAX_ITER = 100000*10
cfg.SOLVER.STEPS = []
...
cfg2.merge_from_file("panopticConfig.yaml")
#cfg2.merge_from_list(['MODEL.DEVICE', 'cuda', 'MODEL.WEIGHTS', 'detectron2://COCO-PanopticSegmentation/panoptic_fpn_R_50_3x/139514569/model_final_c10459.pkl'])
...
frame = read_image("3Kara.jpg", format="BGR")
